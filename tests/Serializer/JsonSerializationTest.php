...
class JsonSerializationTest extends BaseSerializationTest
{
    protected function getContent($key)
    {
        ...
        if (!$outputs) {
            ...
            $outputs['groups_advanced_v2'] = '{"name":"John","manager":{"name":"John Manager","friends":[{"nickname":"nickname"},{"nickname":"nickname"}]},"friends":[{"nickname":"nickname","manager":{"nickname":"nickname"}},{"nickname":"nickname","manager":{"nickname":"nickname"}}]}';
